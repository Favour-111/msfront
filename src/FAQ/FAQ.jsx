...
const FAQ = () => {
  ...
  const mealsectionPolicies = [
    ...
    {
      header: "What is the Mealsection Service Fee",
      content:
        "The Mealsection service fee is a small charge added to each order to help cover the operational costs of running our platform. This fee supports the maintenance of our technology, customer support services, and ensures that we can continue to offer a seamless experience for our users.",
    },
    {
      header: "Why Does Mealsection Charge a Service Fee?",
      content:
    ...
    {
      header: "What is Mealsection?",
      content:
        "Mealsection is a food delivery service designed specifically for students and staff at Crawford University. We partner with local vendors to bring a variety of meals directly to your hostel or campus area, offering convenience, variety, and affordability. Our platform is committed to providing quick and reliable delivery, making it easier for you to satisfy your cravings without leaving campus.At Mealsection, we focus on supporting students by offering employment opportunities, as well as delivering meals that suit your busy schedule. Whether it's lunch, dinner, or a snack, we've got you covered with a range of options from trusted local vendors.",
    },
  ];
  //search state
  ...
  const filteredItem = mealsectionPolicies.filter((item) => {
    if (search === "") {
      return item;
    } else if (
